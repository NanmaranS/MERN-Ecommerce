...
export default function Order() {
  ...
  useEffect(()=>{
    ...
    axios.get('https://mern-ecommerce-back-j8ux.onrender.com/api/orders', {
      headers: { 
  ...
  const cancelOrd= async (prod)=>{
    try {
      const cancelOrder = await axios.delete(
        `https://mern-ecommerce-back-j8ux.onrender.com/api/orders/${prod._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`
          }
              ...
              <div className='d-flex flex-column justify-content-center align-items-center'>
                ...
                <div className="card-body text-center">
                  ...
                  <div className='text-center p-4'>
                    <button className='btn btn-outline-success me-5'>Confirm Order</button>
